...
<head>
    ...
    <title>BandBaaja Hub | Vendor Dashboard - Listing</title>
    <!-- Bootstrap -->
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-8 col-md-8 col-sm-6 col-6">
                    <div class="header-logo">
                        <a href="index.html"><img src="images/logo-white.png" alt="Weddings | Find A Wedding Venue &amp; Supplier WordPress Theme"></a>
                    </div>
                </div>
